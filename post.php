...
<a href="<?php $this->options->siteUrl(); ?>"><i class="fa fa-home"></i>&ensp;首页</a> &raquo; <?php $this->category(' | '); ?> &raquo; <?php echo !empty($this->options->Breadcrumbs) && in_array('Text', $this->options->Breadcrumbs) ? '正文' : htmlspecialchars($this->title, ENT_QUOTES, 'UTF-8'); ?>
</div>
<?php endif; ?>
